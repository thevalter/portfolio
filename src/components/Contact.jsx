...
const Contact = () => {
    ...
    return (
        <div name="Contato" className="w-full h-auto bg-black p-4 text-gray-300">

            <AttentionSeeker effect="bounce">
                <div className="glass flex flex-col p-4 justify-center mt-40 mb-20 h-full w-9/12 mx-auto rounded-3xl shadow-sm">
