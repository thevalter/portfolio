...
const About = () => {
    return (
        <div name="Sobre" className="flex w-full h-screen max-sm:h-auto bg-gradient-to-b from-gray-900 to-black text-gray-300">

            <div className="w-9/12 mx-auto mt-40 flex flex-col justify-center h-auto rounded-3xl bg-black">
